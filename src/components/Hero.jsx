    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <p className="body-1 max-w-3xl mx-auto mb-8 text-light-3 lg:mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Button href="#test-ride" className="bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600">
              Book Test Ride
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h4 className="h4 mb-2">35-40km Range</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="h4 mb-2">25km/hr Speed</h4>
            ...
            <div className="relative bg-light-11 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <ul className="hidden absolute -left-[5.5rem] bottom-[7.5rem] px-1 py-1 bg-light-9/40 backdrop-blur rounded-2xl xl:flex">
